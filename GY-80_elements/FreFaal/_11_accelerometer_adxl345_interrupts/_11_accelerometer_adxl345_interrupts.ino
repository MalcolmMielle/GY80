...
#define INTERRUPTPIN 9   // Arduino pin which is connected to INT1 from the ADXL345
...
void setup()
{
  ...
  // interrupts setup
  writeTo(DEVICE, R_INT_MAP, 0); // write all interrupts to ADXL345's INT1 pin
