...
int pin=2; //Pin branchée aux interruptions
...
void loop() {
  ...
  Read_Magn();
   //GROS DRIFT...
  gyroXangle -= gyroXrate*((double)(micros()-timer)/1000000)-2; // Calcul de l'orientation donnée par le gyro !!OFFSET DE 2 FULL XPERIMENTAL
  ...
  timer = micros();
  affiche();
  accel.readAdvanced(pin);
    //Serial.print("FALLLLING DOWN, I'm Faaalliiiiiiinnnnnnng ddddddooooooooooooooooooooooooooooooowwwwwwwwwwwwn.");
